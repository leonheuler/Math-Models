...
L = subs(L, variables, variablesshort);

dLq1dot = diff(L, q1dot);
dLq2dot = diff(L, q2dot);

dLq1 = diff(L, q1);
dLq2 = diff(L, q2);

dLq1dot = subs(dLq1dot, variablesshort, variables);
dLdtq1dot = diff(dLq1dot, t);
dLdtq1dot = subs(dLdtq1dot, variables, variablesshort);

dLq2dot = subs(dLq2dot, variablesshort, variables);
dLdtq2dot = diff(dLq2dot, t);
dLdtq2dot = subs(dLdtq2dot, variables, variablesshort);
