...
bodyL = animatedline('Marker', 'o', 'MarkerSize', 3, 'LineWidth', 2, 'Color', exo_color);
bodyR = animatedline('Marker', 'o', 'MarkerSize', 3, 'LineWidth', 2, 'Color', exo_color);
...
%     addpoints(bodyL, O2(1), O2(2), O2(3));
   ...
   addpoints(bodyPlanes, O9(1), O9(2), O9(3));
   addpoints(bodyPlanes, O13(1), O13(2), O13(3));
   addpoints(bodyPlanes, O11(1), O11(2), O11(3));
   addpoints(bodyPlanes, O7(1), O7(2), O7(3));
   addpoints(bodyPlanes, O1(1), O1(2), O1(3));
   addpoints(bodyPlanes, O3(1), O3(2), O3(3));
   addpoints(bodyPlanes, O4(1), O4(2), O4(3));   
   addpoints(bodyPlanes, O2(1), O2(2), O2(3)); 
   addpoints(bodyPlanes, O8(1), O8(2), O8(3));
   addpoints(bodyPlanes, O12(1), O12(2), O12(3));   
   addpoints(bodyPlanes, O14(1), O14(2), O14(3));
   addpoints(bodyPlanes, O10(1), O10(2), O10(3));
